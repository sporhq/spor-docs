...
Once a host is [wired](/getting-started/install/) and a repository is enabled
...
replayed later (see [diagnostics](/getting-started/diagnostics/)), and
...
[costs and controls](/getting-started/costs-and-controls/) covers turning
